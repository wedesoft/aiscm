...
(define (slice-rgb arr i n) (if (is-a? (typecode arr) <meta<rgb<>>>) (slice arr i n) arr))
(define-method (red   (self <sequence<>>)) (slice-rgb self 0 3))
(define-method (green (self <sequence<>>)) (slice-rgb self 1 3))
(define-method (blue  (self <sequence<>>)) (slice-rgb self 2 3))

...
(define-method (MOV (r/m <reg<>>) (r <reg<>>))
  (append (op16 r) (REX r r r/m) (if8 r #x88 #x89) (ModR/M r r/m)))
...
(define-method (SHL (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 4 r/m)))
(define-method (SHR (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 5 r/m)))
(define-method (SAL (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 4 r/m)))
(define-method (SAR (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 7 r/m)))

(define-method (ADD (r/m <reg<>>) (r <reg<>>))
  (append (op16 r/m) (REX r r r/m) (if8 r/m #x00 #x01) (ModR/M r r/m)))
...
(define-method (ADD (r <reg<>>) (r/m <addr>))
  (append (op16 r) (REX r r r/m) (if8 r #x02 #x03) (ModR/M r r/m)))
...
(define-method (NEG (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 r/m) (if8 r/m #xf6 #xf7) (ModR/M 3 r/m)))

(define-method (SUB (r/m <reg<>>) (r <reg<>>))
  (append (REX r r r/m) (list #x29) (ModR/M r r/m)))
...
(define-method (CMP (r/m <reg<>>) (r <reg<>>))
  (append (REX r r r/m) (list #x39) (ModR/M r r/m)))

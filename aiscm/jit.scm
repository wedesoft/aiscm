...
(define (mutable-op op args) (make <cmd> #:op op #:io (list (car args)) #:in (cdr args)))
(define (immutable-op op args) (make <cmd> #:op op #:out (list (car args)) #:in (cdr args)))
(define (state-setting-op op args) (make <cmd> #:op op #:in args))
(define (state-reading-op op args) (make <cmd> #:op op #:out args))
(define-method (MOV    . args) (immutable-op     MOV    args))
(define-method (MOVSX  . args) (immutable-op     MOVSX  args))
(define-method (MOVZX  . args) (immutable-op     MOVZX  args))
(define-method (LEA    . args) (immutable-op     LEA    args))
(define-method (SHL    . args) (mutable-op       SHL    args))
(define-method (SHR    . args) (mutable-op       SHR    args))
(define-method (SAL    . args) (mutable-op       SAL    args))
...
(define-method (SUB    . args) (mutable-op       SUB    args))
(define-method (IMUL   . args) (mutable-op       IMUL   args))
(define-method (IDIV   . args) (mutable-op       IDIV   args))
(define-method (DIV    . args) (mutable-op       DIV    args))
(define-method (AND    . args) (mutable-op       AND    args))
(define-method (OR     . args) (mutable-op       OR     args))
(define-method (XOR    . args) (mutable-op       XOR    args))
(define-method (CMP    . args) (state-setting-op CMP    args))
(define-method (TEST   . args) (state-setting-op TEST   args))
(define-method (SETB   . args) (state-reading-op SETB   args))
(define-method (SETNB  . args) (state-reading-op SETNB  args))
(define-method (SETE   . args) (state-reading-op SETE   args))
(define-method (SETNE  . args) (state-reading-op SETNE  args))
(define-method (SETBE  . args) (state-reading-op SETBE  args))
(define-method (SETNBE . args) (state-reading-op SETNBE args))
(define-method (SETL   . args) (state-reading-op SETL   args))
(define-method (SETNL  . args) (state-reading-op SETNL  args))

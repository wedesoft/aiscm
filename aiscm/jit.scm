...
(define ((binary-cmov op1 op2) r a b)
  (if (= (size-of r) 1)
    (list (CMP a b) (MOV r a) (blocked RDX (MOV DL b) (op2 r DX)))
...
(binary-op minor immutable-binary sign-space (binary-cmov cmovnle16 cmovnbe16) identity)
(binary-op major immutable-binary sign-space (binary-cmov cmovl16 cmovb16)     identity)
...
(binary-rgb-op !=     (const <bool>))
(binary-rgb-op major  coerce)
(binary-rgb-op minor  coerce)

...
(define-method (type-conversion (target <meta<ubyte>>) (source <meta<obj>>  )) (native-fun target scm-to-uint8   ))
(define-method (type-conversion (target <meta<byte>> ) (source <meta<obj>>  )) (native-fun target scm-to-int8    ))
(define-method (type-conversion (target <meta<usint>>) (source <meta<obj>>  )) (native-fun target scm-to-uint16  ))
(define-method (type-conversion (target <meta<sint>> ) (source <meta<obj>>  )) (native-fun target scm-to-int16   ))
(define-method (type-conversion (target <meta<uint>> ) (source <meta<obj>>  )) (native-fun target scm-to-uint32  ))
(define-method (type-conversion (target <meta<int>>  ) (source <meta<obj>>  )) (native-fun target scm-to-int32   ))
(define-method (type-conversion (target <meta<ulong>>) (source <meta<obj>>  )) (native-fun target scm-to-uint64  ))
...
(define-method (type-conversion (target <meta<obj>>  ) (source <meta<sint>> )) (native-fun target scm-from-int16 ))
(define-method (type-conversion (target <meta<obj>>  ) (source <meta<uint>> )) (native-fun target scm-from-uint32))
(define-method (type-conversion (target <meta<obj>>  ) (source <meta<int>>  )) (native-fun target scm-from-int32 ))

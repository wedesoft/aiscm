...
(define (ModR/M mod reg/opcode r/m); TODO: use define-method
  (if (and (is-a? r/m <addr>) (get-index r/m))
    (list (logior (ash mod 6) (ash (bits3 reg/opcode) 3) (bits3 #b100))) 
...
(define-method (MOV (r <reg<>>) (r/m <addr>))
  (append (op16 r) (REX r r 0 r/m) (if8 r #x8a #x8b) (ModR/M (if (get-disp r/m) #b01 #b00) r r/m) (SIB r/m) (raw (get-disp r/m) 8)))
...
(define-method (LEA (r <reg<64>>) (r/m <addr>))
  (append (REX r r (or (get-index r/m) 0) r/m) (list #x8d) (ModR/M (if (get-disp r/m) #b01 #b00) r r/m) (SIB r/m) (raw (get-disp r/m) 8)))

(define-method (SHL (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M #b11 4 r/m)))
(define-method (SHR (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M #b11 5 r/m)))

...
(define-jit-method identity -   1 mutating-code   NEG              )
(define-jit-method identity ~   1 mutating-code   NOT              )
(define-jit-method to-bool  =0  1 functional-code test-zero        )
(define-jit-method to-bool  !=0 1 functional-code test-non-zero    )
(define-jit-method to-bool  !   1 functional-code test-zero        )
(define-jit-method coerce   +   2 mutating-code   ADD              )
(define-jit-method coerce   -   2 mutating-code   SUB              )
(define-jit-method coerce   *   2 mutating-code   IMUL             )
(define-jit-method coerce   /   2 functional-code div              )
(define-jit-method coerce   %   2 functional-code mod              )
(define-jit-method coerce   <<  2 mutating-code   shl              )
(define-jit-method coerce   >>  2 mutating-code   shr              )
(define-jit-method coerce   &   2 mutating-code   AND              )
(define-jit-method coerce   |   2 mutating-code   OR               )
(define-jit-method coerce   ^   2 mutating-code   XOR              )
(define-jit-method to-bool  &&  2 mutating-code   bool-and         )
(define-jit-method to-bool  ||  2 mutating-code   bool-or          )
(define-jit-method to-bool  =   2 functional-code cmp-equal        )
(define-jit-method to-bool  !=  2 functional-code cmp-not-equal    )
(define-jit-method to-bool  <   2 functional-code cmp-lower-than   )
(define-jit-method to-bool  <=  2 functional-code cmp-lower-equal  )
(define-jit-method to-bool  >   2 functional-code cmp-greater-than )

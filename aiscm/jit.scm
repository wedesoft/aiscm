...
(define (add-preamble typecode op out . args); TODO: rename
...
(define (functional-code op out . args)
  (apply add-preamble (coerce-args args) op out args))
(define (mutating-code op out . args)
  (insert-intermediate (car args) out (lambda (tmp-a) (apply add-preamble (coerce-args args) op tmp-a (cdr args)))))

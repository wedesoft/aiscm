...
(define-macro (define-nary-collect name arity)
  (let* [(args   (map (lambda (i) (gensym)) (iota arity)))
         (header (cons (list (car args) '<element>) (cdr args)))]
    (cons 'begin
          (map
            (lambda (i)
...
(define-nary-op n-ary-asm identity -   1 mutating-code   NEG)
(define-nary-op n-ary-asm identity ~   1 mutating-code   NOT)
(define-nary-op n-ary-fun to-bool  =0  1 functional-code test-zero)
(define-nary-op n-ary-fun to-bool  !=0 1 functional-code test-non-zero)
(define-nary-op n-ary-fun to-bool  !   1 functional-code test-zero)
(define-nary-op n-ary-asm coerce   +   2 mutating-code   ADD)
(define-nary-op n-ary-asm coerce   -   2 mutating-code   SUB)
(define-nary-op n-ary-asm coerce   *   2 mutating-code   IMUL)
(define-nary-op n-ary-fun coerce   /   2 functional-code div)
(define-nary-op n-ary-fun coerce   %   2 functional-code mod)
(define-nary-op n-ary-fun coerce   <<  2 mutating-code   shl)
(define-nary-op n-ary-fun coerce   >>  2 mutating-code   shr)
(define-nary-op n-ary-asm coerce   &   2 mutating-code   AND)
(define-nary-op n-ary-asm coerce   |   2 mutating-code   OR)
(define-nary-op n-ary-asm coerce   ^   2 mutating-code   XOR)
(define-nary-op n-ary-fun to-bool  &&  2 mutating-code   bool-and)
(define-nary-op n-ary-fun to-bool  ||  2 mutating-code   bool-or)
(define-nary-op n-ary-fun to-bool  =   2 functional-code cmp-equal)
(define-nary-op n-ary-fun to-bool  !=  2 functional-code cmp-not-equal)
(define-nary-op n-ary-fun to-bool  <   2 functional-code cmp-lower-than)
(define-nary-op n-ary-fun to-bool  <=  2 functional-code cmp-lower-equal)
(define-nary-op n-ary-fun to-bool  >   2 functional-code cmp-greater-than)
(define-nary-op n-ary-fun to-bool  >=  2 functional-code cmp-greater-equal)
(define-nary-op n-ary-fun coerce   min 2 functional-code minor)
(define-nary-op n-ary-fun coerce   max 2 functional-code major)

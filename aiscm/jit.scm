...
(define-method (Jcc (target <integer>) code8 code32)
  (append (if (disp8? target) code8 code32) (raw target (if (disp8? target) 8 32))))
...
(define (JMP  target) (Jcc target (list #xeb) (list #xe9)))
(define (JB   target) (Jcc target (list #x72) (list #x0f #x82)))
(define (JNB  target) (Jcc target (list #x73) (list #x0f #x83)))
(define (JE   target) (Jcc target (list #x74) (list #x0f #x84)))
(define (JNE  target) (Jcc target (list #x75) (list #x0f #x85)))
(define (JBE  target) (Jcc target (list #x76) (list #x0f #x86)))
(define (JNBE target) (Jcc target (list #x77) (list #x0f #x87)))
(define (JL   target) (Jcc target (list #x7c) (list #x0f #x8c)))
(define (JNL  target) (Jcc target (list #x7d) (list #x0f #x8d)))
(define (JLE  target) (Jcc target (list #x7e) (list #x0f #x8e)))
(define (JNLE target) (Jcc target (list #x7f) (list #x0f #x8f)))

...
(binary-op &&    immutable-binary sign-space (binary-bool AND)             (cut to-type <bool> <>))
(binary-op ||    immutable-binary sign-space (binary-bool OR)              (cut to-type <bool> <>))
(binary-op minor immutable-binary sign-space (binary-cmov CMOVNLE CMOVNBE) identity)
(binary-op major immutable-binary sign-space (binary-cmov CMOVL CMOVB)     identity)

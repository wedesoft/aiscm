...
(define-operator-mapping -   1 <meta<obj>> (native-fun <obj>  (list <obj>)       obj-negate    ))
(define-method (- (z <integer>) (a <meta<obj>>)) (native-fun <obj> (list <obj>) obj-negate))
(define-operator-mapping ~   1 <meta<obj>> (native-fun <obj>  (list <obj>)       scm-lognot    ))
(define-operator-mapping =0  1 <meta<obj>> (native-fun <bool> (list <obj>)       obj-zero-p    ))
(define-operator-mapping !=0 1 <meta<obj>> (native-fun <bool> (list <obj>)       obj-nonzero-p ))
(define-operator-mapping !   1 <meta<obj>> (native-fun <bool> (list <obj>)       obj-not       ))
(define-operator-mapping +   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-sum       ))
(define-operator-mapping -   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-difference))
(define-operator-mapping *   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-product   ))
(define-operator-mapping /   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-divide    ))
(define-operator-mapping %   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-remainder ))
(define-operator-mapping <<  2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-ash       ))
(define-operator-mapping >>  2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) obj-shr       ))
(define-operator-mapping &   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-logand    ))
(define-operator-mapping |   2 <meta<element>> (native-fun <obj>  (list <obj> <obj>) scm-logior    ))
(define-operator-mapping ^   2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-logxor    ))
(define-operator-mapping &&  2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) obj-and       ))
(define-operator-mapping ||  2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) obj-or        ))
(define-operator-mapping =   2 <meta<obj>> (native-fun <bool> (list <obj> <obj>) obj-equal-p   ))
(define-operator-mapping !=  2 <meta<obj>> (native-fun <bool> (list <obj> <obj>) obj-nequal-p  ))
(define-operator-mapping <   2 <meta<obj>> (native-fun <bool> (list <obj> <obj>) obj-less-p    ))
(define-operator-mapping <=  2 <meta<obj>> (native-fun <bool> (list <obj> <obj>) obj-leq-p     ))
(define-operator-mapping >   2 <meta<obj>> (native-fun <bool> (list <obj> <obj>) obj-gr-p      ))
(define-operator-mapping >=  2 <meta<obj>> (native-fun <bool> (list <obj> <obj>) obj-geq-p     ))
(define-operator-mapping min 2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-min       ))
(define-operator-mapping max 2 <meta<obj>> (native-fun <obj>  (list <obj> <obj>) scm-max       ))

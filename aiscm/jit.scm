...
(define-method (MOV (r/m <address>) (r <reg<8>>))
  (append (REX r r 0 r/m) (opcode #x88) (ModR/M #b00 r r/m)))
(define-method (MOV (r/m <address>) (r <reg<16>>))
  (append (opcode #x66) (REX r r 0 r/m) (opcode #x89) (ModR/M #b00 r r/m)))
...
(define-method (CMP (r/m <reg<>>) (imm32 <integer>))
  (if (equal? (get-code r/m) 0)
    (append (REX r/m 0 0 r/m) (opcode #x3d) (raw imm32 32))
    (append (REX r/m 0 0 r/m) (opcode #x81) (ModR/M #b11 7 r/m) (raw imm32 32))))
(define-method (CMP (r/m <reg<>>) (r <reg<>>))
  (append (REX r r 0 r/m) (opcode #x39) (ModR/M #b11 r r/m)))

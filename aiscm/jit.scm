  ...
  (let* [(result (skel target))
    ...
    (make (fragment (to-type target (type frag)))
          ...
          #:code (const (append ((code frag))
                                ...
                                ((code g))
                                ((code b))))
          #:value (const (rgb ((get-value r)) ((get-value g)) ((get-value b)))))))
(fragment <pointer<>>)
(fragment <sequence<>>)
...
(define-method (red (self <fragment<element>>)); TODO: simplify
  (make (fragment (base (type self)))
        ...
        #:name red
        #:code (code self)
        #:value (const ((protect self red) ((get-value self)))))); TODO: convert back to simple (red of pointer)
(define-method (green (self <fragment<element>>))
  (make (fragment (base (type self)))
        #:args (list self)
        #:name green
        #:code (code self)
        #:value (const ((protect self green) ((get-value self))))))
(define-method (blue (self <fragment<element>>))
  (make (fragment (base (type self)))
        #:args (list self)
        #:name blue
        #:code (code self)
        #:value (const ((protect self blue) ((get-value self))))))

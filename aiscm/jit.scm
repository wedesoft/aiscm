...
(define-unary-op unary-asm identity mutating-code    -  NEG)
(define-unary-op unary-asm identity mutating-code    ~  NOT)
(define-unary-op unary-fun to-bool  functional-code =0  test-zero)
(define-unary-op unary-fun to-bool  functional-code !=0 test-non-zero)
(define-unary-op unary-fun to-bool  functional-code !   test-zero)
...
(define-binary-op binary-asm coerce  mutating-code   +  ADD)
(define-binary-op binary-asm coerce  mutating-code   -  SUB)
(define-binary-op binary-asm coerce  mutating-code   *  IMUL)
(define-binary-op binary-fun coerce  functional-code /  div)
(define-binary-op binary-fun coerce  functional-code %  mod)
(define-binary-op binary-fun coerce  mutating-code   << shl)
(define-binary-op binary-fun coerce  mutating-code   >> shr)
(define-binary-op binary-asm coerce  mutating-code   &  AND)
(define-binary-op binary-asm coerce  mutating-code   |  OR)
(define-binary-op binary-asm coerce  mutating-code   ^  XOR)
(define-binary-op binary-fun to-bool mutating-code   && bool-and)
(define-binary-op binary-fun to-bool mutating-code   || bool-or)
(define-binary-op binary-fun to-bool functional-code =  cmp-equal)
(define-binary-op binary-fun to-bool functional-code != cmp-not-equal)
(define-binary-op binary-fun to-bool functional-code <  cmp-lower-than)
(define-binary-op binary-fun to-bool functional-code <= cmp-lower-equal)
(define-binary-op binary-fun to-bool functional-code >  cmp-greater-than)

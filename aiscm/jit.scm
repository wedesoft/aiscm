...
(define-method (SIB (scale <integer>) (index <reg<>>) (register <reg<>>))
  (list (logior (ash scale 6) (ash (bits3 index) 3) (bits3 register))))
(define-method (SIB (r/m <addr>))
  (if (get-index r/m)
    (SIB (get-scale r/m) (get-index r/m) (get-reg r/m))
...
(define-method (MOV (r/m <reg<>>) (r <reg<>>))
  (append (op16 r) (REX r r 0 r/m) (if8 r #x88 #x89) (ModR/M r r/m)))
...
(define-method (MOVSX (r <reg<>>) (r/m <reg<16>>))
  (append (op16 r) (REX r r 0 r/m) (list #x0f #xbf) (ModR/M r r/m)))
(define-method (MOVSX (r <reg<>>) (r/m <reg<32>>))
  (append (op16 r) (REX r r 0 r/m) (list #x63) (ModR/M r r/m)))
(define-method (MOVZX (r <reg<>>) (r/m <reg<8>>))
  (append (op16 r) (REX r r 0 r/m) (list #x0f #xb6) (ModR/M r r/m)))
...
(define-method (SHR (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 5 r/m)))
(define-method (SAL (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 4 r/m)))
(define-method (SAR (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #xd0 #xd1) (ModR/M 7 r/m)))

(define-method (ADD (r/m <reg<>>) (r <reg<>>))
  (append (op16 r/m) (REX r/m r 0 r/m) (if8 r/m #x00 #x01) (ModR/M r r/m)))
(define-method (ADD (r/m <reg<>>) (imm <integer>))
  (if (equal? (get-code r/m) 0)
    ...
    (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #x80 #x81) (ModR/M 0 r/m) (raw imm (min 32 (get-bits (class-of r/m)))))))
(define-method (ADD (r <reg<>>) (r/m <addr>))
  (append (op16 r) (REX r r 0 r/m) (if8 r #x02 #x03) (ModR/M r r/m)))
...
(define-method (NEG (r/m <reg<>>))
  (append (op16 r/m) (REX r/m 0 0 r/m) (if8 r/m #xf6 #xf7) (ModR/M 3 r/m)))

(define-method (SUB (r/m <reg<>>) (r <reg<>>))
  (append (REX r/m r 0 r/m) (list #x29) (ModR/M r r/m)))
(define-method (SUB (r/m <reg<>>) (imm32 <integer>))
  (if (equal? (get-code r/m) 0)
    (append (REX r/m 0 0 r/m) (list #x2d) (raw imm32 32))
    (append (REX r/m 0 0 r/m) (list #x81) (ModR/M 5 r/m) (raw imm32 32))))

(define-method (CMP (r/m <reg<>>) (imm32 <integer>))
  (if (equal? (get-code r/m) 0)
    (append (REX r/m 0 0 r/m) (list #x3d) (raw imm32 32))
    (append (REX r/m 0 0 r/m) (list #x81) (ModR/M 7 r/m) (raw imm32 32))))
(define-method (CMP (r/m <reg<>>) (r <reg<>>))
  (append (REX r r 0 r/m) (list #x39) (ModR/M r r/m)))

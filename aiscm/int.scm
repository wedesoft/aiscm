...
(define-method (foreign-type (t <meta<int<>>>))
  (cond ((eqv? 64 (bits t)) (if (signed? t) int64 uint64))
        ((eqv? 32 (bits t)) (if (signed? t) int32 uint32))
        ((eqv? 16 (bits t)) (if (signed? t) int16 uint16))
        ((eqv?  8 (bits t)) (if (signed? t)  int8  uint8))))

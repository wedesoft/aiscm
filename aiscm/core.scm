...
(define-syntax-rule (define-object-binary operation delegate)
  (begin
    (define-method (operation (value-a <obj>) (value-b <void>))
      (typed-call <obj> delegate (list <obj> <obj>) (list (to-type <obj> value-a) (to-type <obj> value-b))))
    (define-method (operation (value-a <void>) (value-b <obj>))
      (typed-call <obj> delegate (list <obj> <obj>) (list (to-type <obj> value-a) (to-type <obj> value-b))))
    (define-method (operation (value-a <obj>) (value-b <obj>))
      (typed-call <obj> delegate (list <obj> <obj>) (list (to-type <obj> value-a) (to-type <obj> value-b))))))

(define-object-binary +     "scm_sum"       )
(define-object-binary -     "scm_difference")
(define-object-binary *     "scm_product"   )
(define-object-binary /     "scm_divide"    )
(define-object-binary <<    "scm_ash"       )
(define-object-binary %     "scm_modulo"    )
(define-object-binary &     "scm_logand"    )
(define-object-binary |     "scm_logior"    )
(define-object-binary minor "scm_min"       )
(define-object-binary major "scm_max"       )

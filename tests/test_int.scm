...
(ok (eqv? 16 (bits (coerce (integer 8 signed) (integer 16 signed))))
    "coercion returns largest integer type")
...
(ok (equal? <double> (match 18446744073709551616))
...
(ok (equal? <double> (match -9223372036854775809))
    "type matching for -9223372036854775809")
(ok (equal? <byte> (match 1 -1))
    "match two integers")
...
(ok (equal? '(#f #t) (map !=0 '(0 1)))
    "'!=0' for integers")
(ok (equal? 2 (minor 2 3))
    "minor of 2 and 3")
(ok (equal? 3 (minor 4 3))
    "minor of 4 and 3")
(ok (equal? 3 (major 2 3))
    "major of 2 and 3")
(ok (equal? 4 (major 4 3))
    "major of 4 and 3")

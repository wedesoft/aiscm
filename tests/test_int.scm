...
(ok (equal? (unpack <uint> #vu8(#x01 #x02 #x03 #x04)) (make <uint> #:value #x04030201))
...
(ok (eqv? 2147483647 (get-value (unpack <int> (pack (make <int> #:value 2147483647)))))
  "pack and unpack signed integer")
(ok (eqv? -2147483648 (get-value (unpack <int> (pack (make <int> #:value -2147483648)))))

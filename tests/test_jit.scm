...
(ok (equal? (list (MOV EAX 1) (MOV EDI 2) (MOV ESI 3) (ADD EAX EDI) (ADD EAX ESI) (RET))
...
(skip (equal? (list (MOV EAX 1) (MOV EDI 2) (MOV ESI 3) (ADD EAX EDI) (ADD EAX ESI) (RET))
            (virtual-registers <null> '()
                               (lambda () (list (MOV a 1) (MOV b 2) (MOV c 3) (ADD a b) (ADD a c) (RET)))
                               #:registers (list RSI RDI RAX)))
    "'virtual-registers' should spill variables")

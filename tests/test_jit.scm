...
(ok (eqv? w1 ((asm ctx short (list (MOV RCX (wdata)) (MOV AX (ptr <ptr<16>> RCX)) (RET)))))
    "Load short integer from address in RCX")
(ok (eqv? w2 ((asm ctx short (list (MOV RCX (wdata)) (MOV AX (ptr <ptr<16>> RCX 2)) (RET)))))
    "Load short integer from address in RCX with offset")
(ok (eqv? b1 ((asm ctx int8 (list (MOV RCX (bdata)) (MOV AL (ptr <ptr<8>> RCX)) (RET)))))
    "Load byte from address in RCX")
(ok (eqv? b2 ((asm ctx int8 (list (MOV RCX (bdata)) (MOV AL (ptr <ptr<8>> RCX 1)) (RET)))))

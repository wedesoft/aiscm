...
(ok (equal? '(#xf6 #xdb) (NEG BL))
    "NEG BL")
(ok (eqv? (- i1) ((asm ctx <int> (list (MOV EAX EDI) (NEG EAX)) (list <int>)) i1))
    "Function negating an integer")
(ok (eqv? (- l1) ((asm ctx <long> (list (MOV RAX RDI) (NEG RAX)) (list <long>)) l1))
    "Function negating a long integer")
(ok (eqv? (- w1) ((asm ctx <sint> (list (MOV AX DI) (NEG AX)) (list <sint>)) w1))
    "Function negating a short integer")
(ok (eqv? (- b1) ((asm ctx <byte> (list (MOV AL DIL) (NEG AL)) (list <byte>)) b1))
...
(ok (equal? '(#x41 #x0f #x94 #xc1) (SETE R9L))
    "SETE R9L")
(ok (eqv? 1 ((asm ctx <byte> (list (MOV EAX EDI) (CMP EAX 0) (SETE AL)) (list <int>)) 0))
    "Compare zero in EAX with zero")
(ok (eqv? 0 ((asm ctx <byte> (list (MOV EAX EDI) (CMP EAX 0) (SETE AL)) (list <int>)) (logior 1 i1)))
    "Compare non-zero number in EAX with zero")
(ok (equal? '(#x41 #x81 #xfa #x2a #x00 #x00 #x00) (CMP R10D 42))
    "CMP R10D 42")
(ok (eqv? 1 ((asm ctx <byte> (list (MOV R10D EDI) (CMP R10D 0) (SETE AL)) (list <int>)) 0))
    "Compare zero in R10D with zero")
(ok (eqv? 0 ((asm ctx <byte> (list (MOV R10D EDI) (CMP R10D 0) (SETE AL)) (list <int>)) (logior 1 i1)))
    "Compare non-zero number in R10D with zero")
(ok (equal? '(#x3b #xfe) (CMP EDI ESI))
    "CMP EDI ESI")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETE AL)) (list <int> <int>)) i1 i1))
    "Two integers being equal")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETE AL)) (list <int> <int>)) i1 (logxor 1 i1)))
    "Two integers not being equal")
(ok (equal? '(#x48 #x3b #xf7) (CMP RSI RDI))
    "CMP RSI RDI")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP RSI RDI) (SETE AL)) (list <long> <long>)) l1 l1))
    "Two long integers being equal")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP RSI RDI) (SETE AL)) (list <long> <long>)) l1 (logxor 1 l1)))
    "Two long integers not being equal")
(ok (equal? '(#x41 #x0f #x92 #xc1) (SETB R9L))
    "SETB R9L")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETB AL)) (list <uint> <uint>)) 1 3))
    "Unsigned integer being below another")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETB AL)) (list <uint> <uint>)) 3 3))
    "Unsigned integer not being below another")
(ok (equal? '(#x41 #x0f #x93 #xc1) (SETNB R9L))
    "SETNB R9L")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETNB AL)) (list <uint> <uint>)) 1 3))
    "Unsigned integer not being above or equal")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETNB AL)) (list <uint> <uint>)) 3 3))
    "Unsigned integer being above or equal")
(ok (equal? '(#x41 #x0f #x95 #xc1) (SETNE R9L))
    "SETNE R9L")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETNE AL)) (list <int> <int>)) i1 i1))
    "Two integers not being unequal")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETNE AL)) (list <int> <int>)) i1 (logxor 1 i1)))
    "Two integers being unequal")
(ok (equal? '(#x41 #x0f #x96 #xc1) (SETBE R9L))
    "SETBE R9L")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETBE AL)) (list <uint> <uint>)) 3 3))
    "Unsigned integer being below or equal")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETBE AL)) (list <uint> <uint>)) 4 3))
    "Unsigned integer not being below or equal")
(ok (equal? '(#x41 #x0f #x97 #xc1) (SETNBE R9L))
    "SETNBE R9L")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETNBE AL)) (list <uint> <uint>)) 3 3))
    "Unsigned integer not being above")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETNBE AL)) (list <uint> <uint>)) 4 3))
    "Unsigned integer being above")
(ok (equal? '(#x41 #x0f #x9c #xc1) (SETL R9L))
    "SETL R9L")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETL AL)) (list <int> <int>)) -2 3))
    "Signed integer being less")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETL AL)) (list <int> <int>)) 3 3))
    "Signed integer not being less")
(ok (equal? '(#x41 #x0f #x9d #xc1) (SETNL R9L))
    "SETNL R9L")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETNL AL)) (list <int> <int>)) -2 3))
    "Signed integer not being greater or equal")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETNL AL)) (list <int> <int>)) 3 3))
    "Signed integer being greater or equal")
(ok (equal? '(#x41 #x0f #x9e #xc1) (SETLE R9L))
    "SETLE R9L")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETLE AL)) (list <int> <int>)) -2 -2))
    "Signed integer being less or equal")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETLE AL)) (list <int> <int>)) 3 -2))
    "Signed integer not being less or equal")
(ok (equal? '(#x41 #x0f #x9f #xc1) (SETNLE R9L))
    "SETNLE R9L")
(ok (eqv? 0 ((asm ctx <byte> (list (CMP EDI ESI) (SETNLE AL)) (list <int> <int>)) -2 -2))
    "Signed integer not being greater")
(ok (eqv? 1 ((asm ctx <byte> (list (CMP EDI ESI) (SETNLE AL)) (list <int> <int>)) 3 -2))
...
(ok (equal? '(#x72 #x2a) (JB 42))
    "JB 42")
(ok (eqv? 3 ((asm ctx <int> (list (MOV EAX EDI) (CMP EAX 5) (JB 'l) (MOV EAX 5) 'l) (list <int>)) 3))
    "Test JB with CF=1")
(ok (eqv? 5 ((asm ctx <int> (list (MOV EAX EDI) (CMP EAX 5) (JB 'l) (MOV EAX 5) 'l) (list <int>)) 7))
    "Test JB with CF=0")

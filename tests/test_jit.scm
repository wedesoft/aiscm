...
(ok (equal? (list <int>) (map typecode (content (skeleton <int>))))
    "Decompose integer")
(ok (equal? (list <long>) (map typecode (content (skeleton (pointer <int>)))))
    "Decompose pointer")
(ok (equal? (make-list 3 <int>) (map typecode (content (skeleton <intrgb>))))
    "Decompose RGB value")
...
(ok (equal? (make-list 3 <long>) (map typecode (content (skeleton (sequence <byte>)))))
...
(ok (equal? (make-list 5 <long>) (map typecode (content (skeleton (multiarray <byte> 2)))))

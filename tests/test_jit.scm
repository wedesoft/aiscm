...
(ok (equal? (list (CMP EAX 0) (JE 7) (SUB EAX 1) (JMP -14))
    ...
    "'until' loop")
(ok (equal? (list (MOV ECX 0) (CMP ECX #xa) (JE #x6) (ADD EAX ECX) (INC ECX) (JMP #x-e) (RET))
            (resolve-jumps (register-allocate (flatten-code
              (list (for [(i <int>) (MOV i 0) (CMP i 10) (INC i)] (ADD a i)) (RET))))))
    "'for' loop")
(ok (equal? (list (MOV EDX 0) (MOV ECX 0) (CMP ECX EAX) (JE #x6) (INC EDX) (INC ECX) (JMP #x-a) (RET))

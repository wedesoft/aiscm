...
(ok (equal? (list (JMP 2)) (resolve-jumps (list (JMP tst)) '((tst . 7))))
    "Resolve jump address in trivial program")
(ok (equal? (list (JMP 2) (NOP)) (resolve-jumps (list (JMP tst) (NOP)) '((tst . 7))))
    "Resolve jump address in program with trailing NOP")
(ok (equal? (list (NOP) (JMP 1)) (resolve-jumps (list (NOP) (JMP tst)) '((tst . 7))))

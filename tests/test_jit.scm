...
(ok (lset= equal?
           (list (cons a '(0 . 1)) (cons b '(1 . 2)) (cons c '(2 . 2)))
           (live-intervals (list (list a) (list a b) (list b c) (list)) (list a b c)))
    "Determine live intervals")
(ok (equal? (list (list a b) (list a b c) (list b c))
            (map (overlap (list (cons a '(0 . 1)) (cons b '(1 . 2)) (cons c '(2 . 2)))) (list a b c)))

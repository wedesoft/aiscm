...
(ok (eqv? -1-4i ((jit ctx (list <int> (complex <int>)) -) 2 3+4i))
    "subtract real and complex value")
(ok (eqv? -2-3i ((jit ctx (list (complex <int>)) -) 2+3i))
    "negate complex number")
(ok (eqv? -3-4i ((jit ctx (list (complex <int>) (complex <int>)) -) 2+3i 5+7i))
...
(ok (equal? (list 7+10i) (to-list ((jit ctx (list (sequence (complex <byte>)) (complex <byte>)) +) (seq 2+3i) 5+7i)))

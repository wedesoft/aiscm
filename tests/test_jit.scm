...
(ok (equal? (list (MOV (ptr <long> RSP #x-10) R12) (MOV R12D 0) (MOV R12 (ptr <long> RSP #x-10)) (RET))
            (save-and-use-registers (list (MOV a 0) (RET)) (list (cons a R12)) #:offset #x-10))
...
(ok (equal? (list (MOV EAX 2) (MOV EDI 3) (MOV ESI EAX) (ADD ESI EDI) (RET))
            (replace-variables (list (MOV b 2) (MOV c 3) (MOV a b) (ADD a c) (RET))
                               #:registers (list RSI RDI RAX)))
    "'replace-variables' should use the specified set of registers")
(ok (equal? (list (MOV ESI 2)
...
(ok (equal? (list (MOV (ptr <long> RSP -24) RBX)
                  (MOV ESI 2)
                  (MOV (ptr <int> RSP -8) ESI)
                  (MOV ESI 3)
                  (MOV (ptr <int> RSP -16) ESI)
                  ...
                  (MOV ESI (ptr <int> RSP -16))
                  (ADD EBX ESI)
                  (MOV RBX (ptr <long> RSP -24))
                  (RET))
            (replace-variables (list (MOV b 2) (MOV c 3) (MOV a b) (ADD a c) (RET))
                               #:registers (list RSI RBX)))
    "'replace-variables' should spill variables")

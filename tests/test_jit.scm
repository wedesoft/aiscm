...
(ok (eqv? (+ i1 i2) ((asm ctx <int> (list (MOV EAX i2) (MOV RDX (idata)) (ADD EAX (ptr <int> RDX)) (RET)))))
...
(ok (eqv? i1 ((asm ctx <int> (list (MOV RCX (get-value (+ iptr 50))) (MOV EAX (ptr <int> RCX -200)) (RET)))))
...
(ok (eqv? 17 ((asm ctx <int> (list (MOV EAX (ptr <int> RSP #x8)) (RET))
                   <int> <int> <int> <int> <int> <int> <int> <int>) 2 3 5 7 11 13 17 19))
    "Return seventh integer argument")
(ok (eqv? 19 ((asm ctx <int> (list (MOV EAX (ptr <int> RSP #x10)) (RET))
                   <int> <int> <int> <int> <int> <int> <int> <int>) 2 3 5 7 11 13 17 19))

...
(ok (equal? '(1 3 5) (multiarray->list (downsample (list->multiarray '(1 2 3 4 5)) 2)))
    "Downsampling by 2 with phase 0")
(ok (equal? '((1) (3) (5)) (multiarray->list (downsample (list->multiarray '((1) (2) (3) (4) (5))) 2)))
    "Downsampling of 2D array")
(ok (equal? '((1 2 3)) (multiarray->list (downsample (list->multiarray '((1 2 3) (4 5 6))) '(1 2))))
    "1-2 Downsampling of 2D array")
(ok (equal? '((1 3) (4 6)) (multiarray->list (downsample (list->multiarray '((1 2 3) (4 5 6))) '(2 1))))

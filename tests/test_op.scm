...
(ok (equal? '(257 257 257) (sequence->list (+ (fill! seqb1 1) 256)))
    "add integer to byte sequence")
(ok (equal? '(257 257 257) (sequence->list (+ 256 (fill! seqb1 1))))
    "add byte sequence to integer")
(ok (equal? '(4 4 4) (sequence->list (+ 1 (fill! seqi1 3))))
    "add integer sequence to integer")
(ok (equal? '(4 4 4) (sequence->list (+ (fill! seqi2 1) (fill! seqi1 3))))

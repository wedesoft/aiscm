...
(ok (eqv? (- (get-value i1)) (get-value (- i1)))
    "negate integer")
(ok (equal? '(3 3 3) (begin (fill! seqi1 3) (sequence->list seqi1)))
    "fill integer sequence")
(ok (equal? '(3 3 3) (begin (fill! seqs1 3) (sequence->list seqs1)))
    "fill short integer sequence")
(ok (equal? '(3 3 3) (begin (fill! seqb1 3) (sequence->list seqb1)))
    "fill byte sequence")
(ok (equal? '(3 3 3) (begin (fill! seql1 3) (sequence->list seql1)))

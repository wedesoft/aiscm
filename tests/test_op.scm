...
(ok (equal? '(3 0 1) (multiarray->list (& (list->multiarray '(3 4 5)) 3)))
    "element-wise bit-wise and")
(ok (equal? '(3 7 7) (multiarray->list (| 3 (list->multiarray '(3 4 5)))))
    "element-wise bit-wise or")
(ok (equal? '(1 7 1) (multiarray->list (^ (list->multiarray '(2 3 4)) (list->multiarray '(3 4 5)))))
    "element-wise bit-wise xor")
(ok (equal? '(#f #f #f #t) (multiarray->list (&& (list->multiarray '(#f #t #f #t))
                                                 (list->multiarray '(#f #f #t #t)))))
    "element-wise and")
(ok (equal? '(#f #t #t #t) (multiarray->list (|| (list->multiarray '(#f #t #f #t))
                                                 (list->multiarray '(#f #f #t #t)))))
    "element-wise or")

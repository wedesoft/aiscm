...
(ok (equal? '(#t #f #f) (map (jit ctx (list <obj> <obj>) (lambda (x y) (call <bool> obj-less x y))) '(3 5 7) '(5 5 5)))
    "compile and run lower-than comparison for objects")
(ok (equal? '(#t #t #f) (map (jit ctx (list <obj> <obj>) (lambda (x y) (call <bool> obj-leq x y))) '(3 5 7) '(5 5 5)))
    "compile and run lower-equal comparison for objects")
(ok (equal? '(#f #f #t) (map (jit ctx (list <obj> <obj>) (lambda (x y) (call <bool> obj-gr x y))) '(3 5 7) '(5 5 5)))
    "compile and run greater-than comparison for objects")
(ok (equal? '(#f #t #t) (map (jit ctx (list <obj> <obj>) (lambda (x y) (call <bool> obj-geq x y))) '(3 5 7) '(5 5 5)))

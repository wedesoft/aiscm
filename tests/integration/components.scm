...
(define r (to-array (map (lambda _ (random 256)) (iota count))))
(define g (to-array (map (lambda _ (random 256)) (iota count))))
(define b (to-array (map (lambda _ (random 256)) (iota count))))
(define colors (rgb r g b))

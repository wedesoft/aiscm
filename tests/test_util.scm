...
(ok (equal? '((b . red) (d . green) (a . green) (c . red))
            (color-intervals (adjacent '((b . a) (a . c) (d . c))) '(a b c d) '(red green blue)))
    "'color-intervals' should color adjacent nodes of a graph differently")
(ok (equal? '((b . green) (a . red) (c . green) (d . red))
            (color-intervals (adjacent '((b . a) (a . c) (d . c))) '(a b c) '(red green blue)
                             #:predefined '((d . red))))
    "'color-intervals' should respect predefined colors")
(ok (equal? '((a . #f) (b . red)) (color-intervals (adjacent '((a . b))) '(a b) '(red)))

...
(ok (equal? '(2 2 2) (repeat 2 3))
    "'(repeat a n)' should create a list 'a' repeated 'n' times")
(ok (equal? '(1 1 1) (expand 3 1))
    "'expand' should create a list of repeating elements")
(ok (eqv? 0 (depth 'a))
    "Depth of a symbol is zero")
(ok (eqv? 1 (depth '()))
    "Depth of an empty list is one")
(ok (eqv? 1 (depth '(a b)))
...
(ok (equal? '((b . red) (a . green) (c . red) (d . blue))
            (color-nodes '((b . a) (a . c) (d . c)) '(a b c) '((d . blue)) '(red green blue)))
    "'color-nodes' should take into account predefined colors")

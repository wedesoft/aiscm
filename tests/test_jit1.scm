...
(ok (equal? (list (cons 'a RAX)) (linear-scan-coloring '((a . (0 . 0))) (list RAX)))
...
(let [(a (var <int>))
  ...
  (ok (equal? (list (SUB RSP 8) (MOV ESI 1) (MOV EDI 2) (ADD EDI 3) (ADD ESI 4) (ADD RSP 8) (RET))
...
(let [(a (var <int>))]
  ...
  (let [(b (var <int>))
    ...
    (ok (equal? (list (SUB RSP 8) (MOV EAX 0) (MOV EDX 0) (CMP EDX ECX) (JE #x6) (INC EDX) (INC EAX) (JMP #x-a) (ADD RSP 8) (RET))

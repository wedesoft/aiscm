...
(let [(s (skeleton (sequence <byte>)))]
  ...
  (ok (equal? (list <long> <long> (pointer <byte>)) (map class-of (content (class-of s) s)))
      "skeleton of sequence consists of two long integer variables and a pointer")
...
(let [(m (skeleton (multiarray <int> 2)))]
  ...
  (ok (equal? (list <long> <long> <long> <long> (pointer <int>)) (map class-of (content (class-of m) m)))
      "skeleton of 2D array consists of long integer variables and a pointer") 

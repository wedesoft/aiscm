...
(let [(a (var <int>))
  ...
  (ok (equal? (list (MOV EAX (ptr <int> RSP 8)))
              (update-parameter-locations (list a b c d e f g)
                                          (map cons (list a b c d e f g) (list RDI RSI RDX RCX R8D R9D RAX))
                                          0))
  ...
  (ok (null? (update-parameter-locations (list a b c d e f g)
                                         (map cons (list a b c d e f g) (list RDI RSI RDX RCX R8D R9D (ptr <int> RSP 24)))
                                         16))
      "leave parameter on stack")
  (ok (null? (update-parameter-locations (list a b c d e f g)
                                          (map cons (list a b c d e f) (list RDI RSI RDX RCX R8D R9D))
                                          0))

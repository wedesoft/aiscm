...
sudo apt-get install -q --yes guile-2.0-dev linux-libc-dev gettext libmjpegtools-dev imagemagick libmagickcore-dev libpulse-dev libjpeg-dev libx11-dev libxext-dev libxv-dev libxmu-dev libxi-dev libxpm-dev libglu1-mesa-dev libgl1-mesa-dev libresample1-dev libswscale-dev libavformat-dev libavcodec-dev libavutil-dev pandoc
# try 'libswresample-dev' if 'libresample1-dev' is not present
